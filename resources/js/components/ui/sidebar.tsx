  ...
  return (
    ...
    >
      ...
      >
        <div
          data-sidebar="sidebar"
          className="bg-sidebar group-data-[variant=floating]:border-sidebar-border flex h-full w-full flex-col group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:shadow-sm py-0 px-2"
        >
          {children}
        </div>
      </div>
...
function SidebarTrigger({
  ...
  badge,
  ...props
}: React.ComponentProps<typeof Button> & { badge?: number }) {
    ...
    <div className="relative">
      ...
      { isMobile && (
        badge !== undefined && badge > 0 && (
            <span className="md:hidden absolute -top-2 -right-2 flex h-5 min-w-5 items-center justify-center rounded-full bg-red-500 text-xs font-medium text-white">
            {badge > 99 ? '99+' : badge}
            </span>
        )
      )
...
function SidebarHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      data-sidebar="header"
      className={cn("flex flex-col items-start gap-2 p-0", className)}
      {...props}
    />
  )
}
...
function SidebarGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      data-sidebar="group"
      className={cn("relative flex w-full min-w-0 flex-col px-0 py-2", className)}
      {...props}
    />
  )
}
...
function SidebarMenu({ className, ...props }: React.ComponentProps<"ul">) {
  return (
    <ul
      ...
      data-sidebar="menu"
      className={cn("flex w-full min-w-0 flex-col gap-3 mt-5", className)}
      {...props}
    />
  )
}
