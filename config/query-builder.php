...
return [
     ...
     * For example, fetching the id and name for a userOfferer relation would look like this:
     * GET /users?fields[user_offerer]=id,name
     *
     ...
     * GET /users?fields[userOfferer]=id,name
     */
